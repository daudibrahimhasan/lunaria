...
export const BangladeshPricingSection = () => {
  ...
  const handleAddToCart = (pack: PricingPack) => {
    navigate('/checkout', { state: { quantity: pack.quantity } });
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            <div className="bg-gradient-to-br from-[#FAF9F7] to-[#D4C8E8]/20 rounded-3xl p-6 md:p-8 lg:p-12">
              <div className="w-full h-64 md:h-80 lg:h-96 bg-white rounded-2xl shadow-lg shadow-[#9B7BB5]/10 flex items-center justify-center border border-[#D4C8E8]/20 mb-6 overflow-hidden">
                <img 
                  src={
                    selectedPack === 3 
              ...
              <div className="flex justify-center gap-4">
                {pricing.packs.map((pack) => (
                  <button
                    ...
                    className={`w-14 h-14 md:w-16 md:h-16 rounded-lg border-2 flex items-center justify-center transition-all ${
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-light text-gray-900 mt-4 mb-4">
            ...
            <button 
              ...
              className="w-full px-8 py-4 bg-[#9B7BB5] text-white rounded-full font-medium hover:bg-[#8A6AA4] transition-all hover:shadow-lg hover:shadow-[#9B7BB5]/30 flex items-center justify-center gap-2 mb-4 group"
            >
              ...
              Order Now — {formatPrice(selectedPackData.price, pricing.currency)}
            </button>
